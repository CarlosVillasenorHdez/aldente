...
const PLANS = [
  { key:'medida', name:'A tu medida', price:399, tagline:'Nadie conoce tu negocio mejor que tu.', sub:'Elige exactamente los modulos que necesitas. El precio base incluye POS + KDS. Agregas lo que uses.', color:'#60a5fa', tag:'Nuevo', features:[["POS + KDS incluido","Base siempre activa"],["Modulos activables desde $100/mes","Mesero Movil · Inventario · P&L · Gastos · Reservaciones · Lealtad · Alarmas"],["Solo pagas lo que usas","Activa o desactiva modulos en cualquier momento"],["Sin candados en el sistema","El sidebar solo muestra lo que tienes activo"]] },
