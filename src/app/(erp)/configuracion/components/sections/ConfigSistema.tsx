...
export default function ConfigSistema({ activeSection }: { activeSection: string }) {
  ...
  async function handleSystemReset() {
    ...
    try {
      ...
      await supabase.from('restaurant_layout').eq('tenant_id', getTenantId()).delete().neq('id', '00000000-0000-0000-0000-000000000000');
      // Stock movements (generated by sales)
      await supabase.from('stock_movements').eq('tenant_id', getTenantId()).delete().neq('id', '00000000-0000-0000-0000-000000000000');
