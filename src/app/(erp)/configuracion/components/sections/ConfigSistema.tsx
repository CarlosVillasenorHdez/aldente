...
export default function ConfigSistema({ activeSection }: { activeSection: string }) {
  ...
  async function handleSystemReset() {
    ...
    try {
      ...
      // Gastos (tablas reales: gastos_pagos y gastos_recurrentes)
      try {
        await supabase.from('gastos_pagos').delete().neq('id', '00000000-0000-0000-0000-000000000000');
        await supabase.from('gastos_recurrentes').delete().neq('id', '00000000-0000-0000-0000-000000000000');
      } catch { /* no bloquear el reset si falla */ }
