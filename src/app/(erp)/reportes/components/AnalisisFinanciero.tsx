              ...
              <div style={{ background:'white', borderRadius:12, border:'1px solid #e5e7eb', overflow:'hidden' }}>
                ...
                {plView === 'vertical' ? (
                  <table style={{ width:'100%', borderCollapse:'collapse' }}>
                    <tbody>
                      {plRows.map((row, i) => <PLRowComp key={i} row={row as PLRow} />)}
                    </tbody>
                  </table>
                ) : (
          ...
          {activeTab === 'bs' && (
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:20, alignItems:'start' }}>
              <div style={{ background:'white', borderRadius:12, border:'1px solid #e5e7eb', overflow:'hidden' }}>
                ...
                <table style={{ width:'100%', borderCollapse:'collapse' }}>
                  <tbody>{bsActivos.map((r, i) => <BSRowComp key={i} row={r as BSRow} />)}</tbody>
                </table>
              </div>
              <div style={{ background:'white', borderRadius:12, border:'1px solid #e5e7eb', overflow:'hidden' }}>
                ...
                <table style={{ width:'100%', borderCollapse:'collapse' }}>
                  <tbody>{bsPasivos.map((r, i) => <BSRowComp key={i} row={r as BSRow} />)}</tbody>
                </table>
              </div>
              ...
              <div style={{ background:'white', borderRadius:12, border:'1px solid #e5e7eb', overflow:'hidden' }}>
                ...
                <table style={{ width:'100%', borderCollapse:'collapse' }}>
                  <tbody>
                    ...
                    ].map((row, i) => <PLRowComp key={i} row={row as PLRow} />)}
                  </tbody>
                </table>
              </div>
