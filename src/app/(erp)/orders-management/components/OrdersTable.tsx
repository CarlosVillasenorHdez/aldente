  ...
  const fetchOrders = useCallback(async () => {
    ...
    if (ordersData) {
      setOrders(ordersData.map((o): OrderRecord => ({
        ...
        subtotal: Number((o as any).subtotal),
        iva: Number((o as any).iva),
        discount: Number((o as any).discount),
        total: Number((o as any).total),
        costActual: Number((o as any).cost_actual ?? 0),
        marginActual: Number((o as any).margin_actual ?? 0),
        marginPct: Number((o as any).margin_pct ?? 0),
        status: (o as any).status as OrderStatus,
        payMethod: (o as any).pay_method as PaymentMethod,
        openedAt: (o as any).opened_at,
        closedAt: (o as any).closed_at,
        durationMin: (o as any).duration_min,
