-- ══════════════════════════════════════════════════════════════════════════════
-- Paso 1: Eliminar TODAS las versiones de close_order sin importar la firma
-- ══════════════════════════════════════════════════════════════════════════════
DO $$
DECLARE
  r RECORD;
...
-- ══════════════════════════════════════════════════════════════════════════════
-- Paso 2: Crear la función limpia — todo TEXT, sin UUID
-- ══════════════════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  SET
    ...
    updated_at     = v_now
  WHERE id        = p_order_id
    AND tenant_id = p_tenant_id;   -- ambos TEXT ✓
  ...
  LOOP
    ...
    WHERE id = v_rec.ingredient_id AND tenant_id = p_tenant_id;
  ...
  IF p_loyalty_customer_id IS NOT NULL AND p_loyalty_points > 0 THEN
    ...
    WHERE id = p_loyalty_customer_id AND tenant_id = p_tenant_id;
